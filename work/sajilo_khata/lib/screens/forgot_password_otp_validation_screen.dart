...
import 'package:sajilo_khata/screens/reset_passcode_screen.dart';
...
class ForgotPasswordOtpValidationScreen extends StatefulWidget {
  const ForgotPasswordOtpValidationScreen({Key? key}) : super(key: key);

  @override
  State<ForgotPasswordOtpValidationScreen> createState() => _ForgotPasswordOtpValidationScreenState();
}

class _ForgotPasswordOtpValidationScreenState extends State<ForgotPasswordOtpValidationScreen> {
  @override
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              InkWell(
                                  ...
                                  onTap:(){
                                    Navigator.push(context,MaterialPageRoute(builder: (context)=>const  ResetPascodeScreen()));
                                  }
                              ),
                            ],
                          ),
