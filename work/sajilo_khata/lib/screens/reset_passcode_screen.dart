...
class ResetPascodeScreen extends StatefulWidget {
  const ResetPascodeScreen({Key? key}) : super(key: key);

  @override
  State<ResetPascodeScreen> createState() => _ResetPascodeScreenState();
}

class _ResetPascodeScreenState extends State<ResetPascodeScreen> {
  @override
